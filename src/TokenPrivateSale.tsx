          ...
          <div className="features-grid">
            {[
              ...
              },
              {
                ...
                description: "Supporting technologies that address regulatory requirements like SOH, RUL, and EU 2023/1542"
              },
              {
                icon: (
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Projected 10x to 200x return on investment within a 2-4 year timeframe"
              }
            ].map((feature, index) => (
