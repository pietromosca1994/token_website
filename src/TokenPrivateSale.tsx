    ...
    <div className="main-page">
      ...
      <div className="main-content">
        <div className="sale-hero">
          ...
          <div className="eagle-card glow-effect">
            <div className="eagle-logo">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2L2 12H5V20H19V12H22L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <h2>$EAGLE</h2>
            <p>The governance token powering the Eagle Labs ecosystem</p>
          </div>
        </div>
